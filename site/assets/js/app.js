...
(() => {
  ...
  const CONF_DESC = {
    ...
    "psi": "PSI — Statisticians in the Pharmaceutical Industry; conference abstracts with official PDFs (2025–).",
    "cdisc-interchange": "CDISC Interchange — global & regional conferences on clinical data standards, with presentation archives.",
    "user-r": "useR! — the international R user conference; talks, tutorials and abstracts.",
    "r-medicine": "R/Medicine — R for medical research, clinical data science and regulatory submissions.",
